...
- Point it at a folder and the model can read files in it, search filenames by glob, and grep contents. Each capability toggles independently, and each can be auto-approved or gated behind a one-off confirmation.
